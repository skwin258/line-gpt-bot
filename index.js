...
const allowedUsers = new Set([
  ...
  'U1cebd63109f62550c10df0ab835a900c', // 管理員 UID（你提供的）
...
const getChatId = (e)=> e?.source?.type==='group'? e.source.groupId : (e?.source?.type==='room'? e.source.roomId : e?.source?.userId);
